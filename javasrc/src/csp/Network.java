...
public class Network {
	...
	public static void main(String[] args){
		...
		str.removeIf(s -> s.equals("a"));
        System.out.println("##### " + str.get(0));

		Assignment a = new Assignment();
		a.put("x", 2);
        System.out.println("C1^^^ " + c1.violation(a));
		a.put("y", "if");
        System.out.println("C1^^^ " + c1.violation(a));
        System.out.println("C2^^^ " + c2.violation(a));
        ...
        ArrayList<String> str2 = str.stream().sorted()
                .collect(Collectors.toCollection(ArrayList::new));

        System.out.println(str2);

		System.out.println("!!!!!!!! " + str.containsAll(a.getVars()));
